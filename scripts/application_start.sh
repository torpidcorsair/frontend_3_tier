...
sudo aws s3 cp s3://hypha-arun-bucket/app.js /var/www/html/
sudo aws s3 cp s3://hypha-arun-bucket/package.json /var/www/html/
sudo aws s3 cp s3://hypha-arun-bucket/package-lock.json /var/www/html/
sudo aws s3 cp --recursive s3://hypha-arun-bucket/node_modules /var/www/html/node_modules
